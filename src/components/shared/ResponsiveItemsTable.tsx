        ...
        <div className="grid grid-cols-2 gap-2">
          <div>
            ...
            {(() => {
              ...
              const qtyErrorId = `mobile-item-qty-error-${index}`;
              return (
                <>
                  <Input
                    type="number"
                    ...
                    className={`h-9 ${qtyInvalid ? 'border-destructive focus-visible:ring-destructive' : ''}`}
                  />
                  {qtyInvalid && (
                    <p id={qtyErrorId} role="alert" className="text-[10px] text-destructive mt-1">
